...
My name is Merdzhen, I am a Go Developer
...
- **Backend**: Go
- **Database**: PostgreSQL
- **Frontend**: HTML5, CSS3, Sass, JS, TS, Next.js, React, RTK, Material UI
- **And also**: Git

---
### 📁 Latest Projects as Frontend Dev:

- https://loyalty.retain.ru (admin panel) (Next.js, Material UI)
